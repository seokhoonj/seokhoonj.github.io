...
\\( \begin{pmatrix} \frac{1}{N} & 0 & 0 & 0 \\\\ 0 & \frac{1}{N} & 0 & 0 \\\\ \vdots & \vdots & \vdots & \vdots \\\\ 0 & 0 & 0 & \frac{1}{N} \end{pmatrix} \begin{pmatrix} x\_1^{(1)} & x\_1^{(2)} & \ldots & x\_1^{(N)} \\\\ x\_2^{(1)} & x\_2^{(2)} & \ldots & x\_2^{(N)} \\\\ \vdots  & \vdots & \vdots & \vdots \\\\ x\_D^{(1)} & x\_D^{(2)} & \ldots & x\_D^{(N)} \end{pmatrix} \frac{x^{(1)}}{N} \\)
