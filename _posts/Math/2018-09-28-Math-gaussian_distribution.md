...
\\( \begin{pmatrix} x\_1^{(1)} & x\_1^{(2)} & \ldots & x\_1^{(N)} \\\\ x\_2^{(1)} & x\_2^{(2)} & \ldots & x\_2^{(N)} \\\\ \vdots  & \vdots & \vdots & \vdots \\\\ x\_D^{(1)} & x\_D^{(2)} & \ldots & x\_D^{(N)} \end{pmatrix} \left(\begin{array}{c} \frac{1}{N} \\\\ \frac{1}{N} \\\\ \vdots \\\\ \frac{1}{N} \end{array}\right) = \left(\begin{array}{cccc} \frac{x\_1}{N} & \frac{x\_2}{N} & \ldots & \frac{x\_D}{N} \end{array}\right) = \left(\begin{array}{cccc} \mu\_1 & \mu\_2 & \ldots & \mu\_D \end{array}\right) \\)
